...
MODEL_PATH = 'models/train_final_focal_loss_retrain_load_15_-epoch-28.hdf5'
...
# model.save('models/vgg19_local.h5df')

model = load_model('models/vgg19_local.h5df')
...
def upload():
    if request.method == 'POST':
        ...
        prob = [preds2[i] for i in index[0]]
        prediction_label = set(zip (prediction_label,prob))
